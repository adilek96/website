    ...
    >
      ...
      <form>
        <input
          ...
          className="mb-4 w-full rounded-md border border-body-color border-opacity-10 px-6 py-3 text-base font-medium text-body-color placeholder-body-color outline-none focus:border-primary focus:border-opacity-100 focus-visible:shadow-none dark:border-white dark:border-opacity-10 dark:bg-input-color focus:dark:border-opacity-50"
        />
        <input
          type="email"
          name="email"

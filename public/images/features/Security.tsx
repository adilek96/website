  ...
  return (
    ...
    >
      <g>
        <g>
          <path
            d="M29.9,17.5C29.7,17.2,29.4,17,29,17c-2.2,0-4.3,1-5.6,2.8L22.5,21c-1.1,1.3-2.8,2-4.5,2h-3c-0.6,0-1-0.4-1-1s0.4-1,1-1
      ...
      <path
        d="M12.9,15H19c1.6,0,3,1.3,3,2.9l0,0.2c0,0.1,0,0.1,0,0.2c1-1.2,2.2-2.1,3.7-2.7C27.3,12.7,28,9,28,4.3c0-0.3-0.2-0.6-0.4-0.8

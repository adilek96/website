...
export default function DashboardLayout({
  ...
  return (
    <section className="overflow-hidden pt-[180px] pb-[120px]">
      <div className="container flex w-full  justify-around px-4 ">
        <div className="h-[100vh] w-[20vw] rounded-md bg-body-color  bg-opacity-30 py-5 pl-2 dark:bg-dark">
          <ul className="ml-10 flex h-full flex-col justify-center gap-4 text-lg">
